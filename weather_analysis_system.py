...
class WeatherAnalysisSystem:
    """
    Advanced weather rubric system with corrected habitability scoring
    and scientifically accurate exoplanet atmospheric data.
    """
    ...
    def generate_exoplanet_data(self):
        """Generate scientifically accurate exoplanet data with proper temperatures and wind variance."""
        print("Generating exoplanet atmospheric data...")
        
        # Exoplanet data based on scientific estimates
        exoplanet_data = {
            'GJ_1214b': {
                'scenarios': {
        ...
        for planet_name, planet_info in exoplanet_data.items():
        ...
        exoplanet_df = pd.DataFrame(all_data)
        
        # Save exoplanet data
        output_path = '/Users/vasubansal/code/universal_atmospheric_model/data/predictions/exoplanet_data.csv'
        exoplanet_df.to_csv(output_path, index=False)
        print(f"✓ Exoplanet data saved to: exoplanet_data.csv")
        
        return exoplanet_df
    
    def calculate_habitability_score(self, planet_data):
        """
        Calculate habitability score with Earth as the clear winner.
    ...
    def create_summary_data(self, exoplanet_df):
        """Create summary statistics from exoplanet data."""
        print("Creating summary statistics...")
        
        summary_data = []
        
        for planet in exoplanet_df['planet'].unique():
            for scenario in exoplanet_df['spiciness'].unique():
                subset = exoplanet_df[(exoplanet_df['planet'] == planet) & 
                                    (exoplanet_df['spiciness'] == scenario)]
        ...
        # Save summary
        output_path = '/Users/vasubansal/code/universal_atmospheric_model/data/predictions/exoplanet_summary.csv'
        summary_df.to_csv(output_path, index=False)
        print(f"✓ Summary data saved to: exoplanet_summary.csv")
        
        return summary_df
    
    def calculate_all_weather_scores(self):
        """Calculate weather scores for all planets."""
        print("\n" + "="*80)
        print("WEATHER ANALYSIS - CALCULATING WEATHER SCORES")
        print("="*80)
        
        all_scores = []
        
        # 1. Generate exoplanet data
        exoplanet_df = self.generate_exoplanet_data()
        summary_df = self.create_summary_data(exoplanet_df)
        ...
        # Calculate scores using advanced methods
        earth_scores = {
            ...
            'Habitability Potential': self.calculate_habitability_score(earth_summary),
        ...
        mars_scores = {
            ...
            'Habitability Potential': self.calculate_habitability_score(mars_summary),
        ...
        print("\nCalculating exoplanet weather scores...")
        for _, planet_data in summary_df.iterrows():
            ...
            scores = {
                ...
                'Habitability Potential': self.calculate_habitability_score(planet_data),
        ...
        # Save unified scores
        output_path = '/Users/vasubansal/code/universal_atmospheric_model/data/predictions/unified_weather_scores.csv'
        self.unified_scores.to_csv(output_path, index=False)
        print(f"\n✓ Unified scores saved to: unified_weather_scores.csv")
        
        return self.unified_scores

def main():
    """Run the weather analysis system."""
    print("="*80)
    print("WEATHER ANALYSIS SYSTEM")
    print("="*80)
    print("Advanced weather scoring with Earth properly ranked as most habitable")
    
    # Initialize weather analysis system
    ...
    print("="*80)
    print("Files created:")
    print("- exoplanet_data.csv (exoplanet atmospheric data)")
    print("- exoplanet_summary.csv (summary statistics)")  
    print("- unified_weather_scores.csv (all planet scores)")
